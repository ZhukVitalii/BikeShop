...
<html>
<head>
    <title>${grips.name}/</title>
    <spring:url value="${grips.url}/resources/css/bootstrap.css" var="bootstrap"/>
    <link href="${grips.url}/resources/css/bootstrap.css" rel='stylesheet' type='text/css' />
    <!-- jQuery (Bootstrap's JavaScript plugins) -->
    <script src="${grips.url}/resources/js/jquery.min.js"></script>
    <!-- Custom Theme files -->
    <link href="${grips.url}/resources/css/form.css" rel="stylesheet" type="text/css" media="all" />
    <link href="${grips.url}/resources/css/style.css" rel="stylesheet" type="text/css" media="all" />
    <!-- Custom Theme files -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
    ...
    <!--webfont-->
    <!-- dropdown -->
    <script src="${grips.url}/resources/js/jquery.easydropdown.js"></script>
    <link href="${grips.url}/resources/css/nav.css" rel="stylesheet" type="text/css" media="all"/>
    <script src="${grips.url}/resources/js/scripts.js" type="text/javascript"></script>
    <!--js-->
</head>
<body>
<script src="${grips.url}/resources/js/responsiveslides.min.js"></script>
<script>
    $(function () {
...
<div class="banner-bg banner-sec">
    <div class="container">
        <div class="header">
            <div class="logo">
                <a href="/"><img src="${grips.url}/resources/images/logo.png"
                                 alt=""
                                 width="110"
                                 height="112"/>
                </a>
            ...
            <div class="top-nav">
                ...
                <ul class="nav">
                    ...
                    <a class="shop" href="/cart"><img src="${grips.url}/resources/images/cart.png" alt=""/></a>
                </ul>
            </div>
            ...
            <div class="ctnt-bar cntnt">
                <div class="content-bar">
                    <div class="single-page">
                        ...
                        <link rel="stylesheet" href="${grips.url}/resources/css/etalage.css">
                        <script src="${grips.url}/resources/js/jquery.etalage.min.js"></script>
                        <script>
                        ...
                        <div class="details-left-slider">
                            ...
                            <div class="details-left-info">
                                ...
                                <p class="maker"> <h3> Виробник  : ${grips.handlebarMaker.name} </h3></p>
                                <h4></h4>
                                <p>${grips.price}<label>грн</label><a href="#"></a></p>
                                <div class="btn_form">
                                    <a href="cart.html">Купити</a>
                                    <a href="/cartAddGrips/${grips.article}">Додати до корзини</a>
                                </div>
                                <div class="bike-type">
                                    <table>
                                        <tr>
