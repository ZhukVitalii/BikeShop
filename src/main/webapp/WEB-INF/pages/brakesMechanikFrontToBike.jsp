...
<html>
<head>
    <title>Brakes Disc Mechanik Front</title>
            ...
            <div class="details-left-slider">
                <a href="<c:url value="/brakeDiscMechanik/${brakeDiscMechanik.url}"/>"
                   title="Перейти до <c:out value="${brakeDiscMechanik.name}"/>">
                    <img height="300" width="300" src="${brakeDiscMechanik.way}" />
                </a>
                <div class="details-left-info">
                    ...
                    <h5> Артикул  : ${brakeDiscMechanik.article}</h5>
                    <p class="manufacturer"> <h5> Виробник  : ${brakeDiscMechanik.brakeMaker.name} </h5></p>
                    <h4></h4>
                    <p>${brakeDiscMechanik.price}<label>грн</label><a href="#"></a></p>
                    <div class="btn_form">
                        <a href="/chooseDiscMechanikBack/${brakeDiscMechanik.id}">Підібрати задні гальма в комплект до даних </a>
                        <a href="/cartAddBrakeDiscMechanik/${brakeDiscMechanik.article}">Додати до корзини</a>
                    </div>
                    <div class="bike-type">
                        <table>
                            <tr>
                                ...
                                <th><p align="center"><font size="4" color="#0080C0" >
                                    <b><i>   ${brakeDiscMechanik.location.local}</i></b></font></th>
                            </tr>
                        </table>
                        ...
                        <table>
                            <tr>
                                ...
                                <th><p align="center"><font size="4" color="#0080C0" >
                                    <b><i>   ${brakeDiscMechanik.rotorDiam.diam} </i></b></font></th>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                ...
                                <th><p align="center"><font size="4" color="#0080C0" >
                                    <b><i>   ${brakeDiscMechanik.rotorWeight} </i></b></font></th>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                ...
                                <th><p align="center"><font size="4" color="#0080C0" >
                                    <b><i>   ${brakeDiscMechanik.materialBrake} </i></b></font></th>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                ...
                                <th><p align="center"><font size="4" color="#0080C0" >
                                    <b><i>   ${brakeDiscMechanik.brakeWeight} </i></b></font></th>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                ...
                                <th><p align="center"><font size="4" color="#0080C0" >
                                    <b><i>   ${brakeDiscMechanik.rotorFixType.type} </i></b></font></th>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                <th><h5>Колір  :   </h5></th>
                                <th><p align="center"><font size="4" color="#0080C0" >
                                    <b><i>   ${brakeDiscMechanik.color} </i></b></font></th>
                            </tr>
                        </table>
                        <h5>Опис  ::</h5>
                        <p class="desc">${brakeDiscMechanik.description}</p>
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
