...
<html>
<head>
    <title>Brakes V-Brake Back</title>
        ...
        <c:forEach items="${brakeVBrakes}" var="brakeVBrake">
            ...
            <div class="details-left-slider">
                ...
                <div class="details-left-info">
                    ...
                    <div class="btn_form">
                        <a href="/chooseHandlebar/${'vBrake'}/${brakeVBrake.id}">Підібрати компоненти під дані гальма</a>
                        <button type="button" onclick="addToCart('/cartAddBrakeVBrake/', ${brakeVBrake.article})">Додати до корзини</button>
                    </div>
                    <div class="bike-type">
                        <table>
                            <tr>
