...
<div id="cate" class="categories">
    <div class="container">
        <h3>Категорії</h3>
        <div class="row">
            <a href="/chooseDiscHydraulic"><div class="col-md-6 col-sm-12 col-xs-12 component grid1">
                <h4>Дискові гальма гідравлічні</h4>
                <a class="store" href="/chooseDiscHydraulic">Вибрати</a>
            </div></a>
            <a href="/chooseDiscMechanik"><div class="col-md-6 col-sm-12 col-xs-12 component grid2">
