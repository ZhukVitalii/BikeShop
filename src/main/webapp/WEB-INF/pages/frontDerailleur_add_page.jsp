...
<div class="container">
    <form role="form" class="form-horizontal" action="/frontDerailleur/add" method="post">
        ...
        <br>
        <select class="btn btn-primary btn-select btn-select-light" name="teethCapasity">
        ...
        <br>
        <input class="form-control " type="text" name="chainLine" placeholder="Лінія ланцюга">
        <br>
        <select class="btn btn-primary btn-select btn-select-light" name="frontDerailleurFixType">
        ...
        <br>
        <select class="btn btn-primary btn-select btn-select-light" name="collarDiam">
        ...
        <br>
        <select class="btn btn-primary btn-select btn-select-light" name="tractionType">
