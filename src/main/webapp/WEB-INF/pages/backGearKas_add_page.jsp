...
<html>
<head>
    <title>New back gearKas</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/css/bootstrap.min.css">
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/js/bootstrap.min.js"></script>
</head>
<body>
<div class="container">
    <form role="form" class="form-horizontal" action="/backGearKas/add" method="post">
        <h3>Додати касету</h3>
        ...
        <br>
        <select class="btn btn-primary btn-select btn-select-light" name="backSprocketSize">
            <option value="-1">Набір зірок</option>
            <c:forEach items="${backSprocketSize}" var="backSprocketSize">
