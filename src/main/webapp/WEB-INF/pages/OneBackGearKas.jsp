...
<html>
<head>
    <title>${backGearKas.name}/</title>
    <link rel="shortcut icon"
          href="resources/images/logo_brauser.png" >
    <spring:url value="${backGearKas.url}/resources/css/bootstrap.css" var="bootstrap"/>
    <link href="${backGearKas.url}/resources/css/bootstrap.css" rel='stylesheet' type='text/css' />
    <!-- jQuery (Bootstrap's JavaScript plugins) -->
    <script src="${backGearKas.url}/resources/js/jquery.min.js"></script>
    <!-- Custom Theme files -->
    <link href="${backGearKas.url}/resources/css/form.css" rel="stylesheet" type="text/css" media="all" />
    <link href="${backGearKas.url}/resources/css/style.css" rel="stylesheet" type="text/css" media="all" />
    <!-- Custom Theme files -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
    ...
    <!--webfont-->
    <!-- dropdown -->
    <script src="${backGearKas.url}/resources/js/jquery.easydropdown.js"></script>
    <link href="${backGearKas.url}/resources/css/nav.css" rel="stylesheet" type="text/css" media="all"/>
    <script src="${backGearKas.url}/resources/js/scripts.js" type="text/javascript"></script>
    <!--js-->
</head>
<body>
<script src="${backGearKas.url}/resources/js/responsiveslides.min.js"></script>
<script>
    $(function () {
...
<div class="banner-bg banner-sec">
    <div class="container">
        <div class="header">
            <div class="logo">
                <a href="/"><img src="${backGearKas.url}/resources/images/logo.png"
                                 alt=""
                                 width="110"
                                 height="112"/>
                </a>
            ...
            <div class="ctnt-bar cntnt">
                <div class="content-bar">
                    <div class="single-page">
                        ...
                        <link rel="stylesheet" href="${backGearKas.url}/resources/css/etalage.css">
                        <script src="${backGearKas.url}/resources/js/jquery.etalage.min.js"></script>
                        <script>
                                ...
                                <div class="btn_form">
                                    ...
                                    <script>
                                        function addToCart() {
                                            ...
                                            xhttp.open("POST", "/cartAddBackGearKas/${backGearKas.article}", true);
                                            xhttp.send(${backGearKas.article});
                                        }
                                    </script>
                                </div>
                                <div class="bike-type">
