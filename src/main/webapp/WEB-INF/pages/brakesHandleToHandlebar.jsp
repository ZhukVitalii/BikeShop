    ...
    <div class="product">
        ...
        <c:forEach items="${brakeHandles}" var="brakeHandle">
            ...
            <div class="details-left-slider">
                <a href="<c:url value="/brakeHandlec/${brakeHandle.url}"/>"
                ...
                <div class="details-left-info">
                    ...
                    <div class="btn_form">
                        <a href="/chooseGrips/${brakeHandle.id}">Підібрати компоненти під дані гальма</a>
                        <button type="button" onclick="addToCart('/cartAddBrakeHandle',${brakeHandle.article})">Додати до корзини</button>
                    </div>
                    <div class="bike-type">
                        <table>
                            <tr>
