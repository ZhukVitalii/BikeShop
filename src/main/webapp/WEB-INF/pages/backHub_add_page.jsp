...
<body>
<div class="container">
    <form role="form" class="form-horizontal" action="/backHub/add" method="post">
        <h3>New backHub</h3>
        ...
        <select class=" btn btn-primary btn-select btn-select-light "  name="hubFixType">
        ...
        <br>
        <select class=" btn btn-primary btn-select btn-select-light "  name="axisLength">
        ...
        <br>
        <select class=" btn btn-primary btn-select btn-select-light "  name="axisDiam">
        ...
        <br>
        <select class="btn btn-primary btn-select btn-select-light "  name="backSprocketType">
