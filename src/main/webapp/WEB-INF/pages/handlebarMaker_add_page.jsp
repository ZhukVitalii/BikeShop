...
<html>
<head>
    <title>New handlebarMaker</title>
...
<body>
<div class="container">
    <form role="form" class="form-horizontal" action="/admin/handlebarMaker/add" method="post">
        <div class="form-handlebarMaker"><h3>New handlebarMaker</h3></div>
