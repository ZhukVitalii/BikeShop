        ...
        <c:forEach items="${backDerailleurs}" var="backDerailleur">
            ...
            <div class="details-left-slider">
                ...
                <div class="details-left-info">
                    ...
                    <div class="btn_form">
                        <a href="/chooseFrontDerailleur/${backDerailleur.id}">Підібрати компоненти під дану перекидку</a>
                        <button type="button" onclick="addToCart('/cartAddBackDerailleur/',${backDerailleur.article})">Додати до корзини</button>
                    </div>
                    <div class="bike-type">
                        <table>
                            <tr>
