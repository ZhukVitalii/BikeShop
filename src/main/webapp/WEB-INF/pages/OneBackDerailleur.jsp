...
<html>
<head>
    <title>${backDerailleur.name}/</title>
    <link rel="shortcut icon"
          href="resources/images/logo_brauser.png" >
    <spring:url value="${backDerailleur.url}/resources/css/bootstrap.css" var="bootstrap"/>
    <link href="${backDerailleur.url}/resources/css/bootstrap.css" rel='stylesheet' type='text/css' />
    <!-- jQuery (Bootstrap's JavaScript plugins) -->
    <script src="${backDerailleur.url}/resources/js/jquery.min.js"></script>
    <!-- Custom Theme files -->
    <link href="${backDerailleur.url}/resources/css/form.css" rel="stylesheet" type="text/css" media="all" />
    <link href="${backDerailleur.url}/resources/css/style.css" rel="stylesheet" type="text/css" media="all" />
    <!-- Custom Theme files -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
    ...
    <!--webfont-->
    <!-- dropdown -->
    <script src="${backDerailleur.url}/resources/js/jquery.easydropdown.js"></script>
    <link href="${backDerailleur.url}/resources/css/nav.css" rel="stylesheet" type="text/css" media="all"/>
    <script src="${backDerailleur.url}/resources/js/scripts.js" type="text/javascript"></script>
    <!--js-->
</head>
<body>
<script src="${backDerailleur.url}/resources/js/responsiveslides.min.js"></script>
<script>
    $(function () {
...
<div class="banner-bg banner-sec">
    <div class="container">
        <div class="header">
            <div class="logo">
                <a href="/"><img src="${backDerailleur.url}/resources/images/logo.png"
                                 alt=""
                                 width="110"
                                 height="112"/>
                </a>
            ...
            <div class="ctnt-bar cntnt">
                <div class="content-bar">
                    <div class="single-page">
                        ...
                        <link rel="stylesheet" href="${backDerailleur.url}/resources/css/etalage.css">
                        <script src="${backDerailleur.url}/resources/js/jquery.etalage.min.js"></script>
                        <script>
                                ...
                                <div class="btn_form">
                                    ...
                                    <script>
                                        function addToCart() {
                                            ...
                                            xhttp.open("POST", "/cartAddBackDerailleur/${backDerailleur.article}", true);
                                            xhttp.send(${backDerailleur.article});
                                        }
                                    </script>
                                </div>
                                <div class="bike-type">
