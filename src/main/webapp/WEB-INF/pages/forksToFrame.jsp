                    ...
                    <div class="single-page">
                        ...
                        <div class="details-left-slider">
                            ...
                            <div class="details-left-info">
                                ...
                                <p class="maker"> <h5> Виробник  : ${fork.maker.name} </h5></p>
                                <h4></h4>
                                <p>${fork.price}<label>грн</label><a href="#"></a></p>
                                <div class="btn_form">
                                    <a href="/chooseWheel/${fork.id}">Підібрати компоненти під дану вилку</a>
                                    <button type="button" onclick="addToCart('/cartAddFork/', ${fork.article})">Додати до корзини</button>
                                </div>
                                <div class="bike-type">
