...
<body>
<div class="container">
    <form role="form" class="form-horizontal" action="/rim/add" method="post">
        <h3>New rim</h3>
        ...
        <br>
        <select class=" btn btn-primary btn-select btn-select-light "  name="etrtoSize">
        ...
        <br>
        <select class="btn btn-primary btn-select btn-select-light "  name="innerTubeDiameter">
        ...
        <br>
        <select class="btn btn-primary btn-select btn-select-light "  name="rimHeight">
        ...
        <select class="btn btn-primary btn-select btn-select-light "  name="nipple">
        ...
        <input class="form-control form-forkMaker" type="text" name="description" placeholder="Опис обода">
