                    ...
                    <div class="single-page">
                        ...
                        <div class="details-left-slider">
                            ...
                            <div class="details-left-info">
                                ...
                                <div class="btn_form">
                                    <button type="button" onclick="addToCart('/cartAddBackHub',${backHub.article})">Додати до корзини</button>
                                </div>
                                <div class="bike-type">
                                    <table>
                                        <tr>
            ...
            <ul class="pagination">
                <c:if test="${allPages ne null}">
                    <c:forEach var="i" begin="1" end="${allPages}">
                        <li><a href="/show_backHubs?page=<c:out value="${i - 1}"/>"><c:out value="${i}"/></a></li>
                    </c:forEach>
                </c:if>
