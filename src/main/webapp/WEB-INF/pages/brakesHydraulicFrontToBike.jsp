...
<html>
<head>
    <title>Brakes Disc Hydraulic Front</title>
        ...
        <c:forEach items="${brakeDiscHydraulics}" var="brakeDiscHydraulic">
            ...
            <div class="details-left-slider">
                ...
                <div class="details-left-info">
                    ...
                    <div class="btn_form">
                        <a href="/chooseDiscHydraulicBack/${brakeDiscHydraulic.id}">Підібрати задні гальма з даними передніми</a>
                        <button type="button" onclick="addToCart('/cartAddBrakeDiscHydraulic/',${brakeDiscHydraulic.article})">Додати до корзини</button>
                    </div>
                    <div class="bike-type">
                        <table>
                            <tr>
