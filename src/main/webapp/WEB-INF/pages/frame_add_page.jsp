...
<body>
<div class="container">
    <form role="form" class="form-horizontal" action="/frame/add" method="post">
        <h3>Додати раму</h3>
        <select class="btn btn-primary btn-select btn-select-light" name="frameMaker">
        ...
        <br>
        <select class="btn btn-primary btn-select btn-select-light" name="frameSize">
        ...
        <br>
        <select class="btn btn-primary btn-select btn-select-light" name="headsetType">
        ...
        <br>
        <select class="btn btn-primary btn-select btn-select-light" name="tubeDiameter">
        ...
        <br>
        <select class="btn btn-primary btn-select btn-select-light" name="underSaddleTube">
        ...
        <br>
        <select class="btn btn-primary btn-select btn-select-light" name="trunkBinding">
