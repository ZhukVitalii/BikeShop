...
<html>
<head>
    <title>New Transmission Maker</title>
...
<body>
<div class="container">
    <form role="form" class="form-horizontal" action="/admin/transmissionMaker/add" method="post">
        <div class="form-handlebarMaker"><h3>Новий виробник</h3></div>
