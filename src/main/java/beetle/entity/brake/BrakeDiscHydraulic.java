 ...
 */
@Entity
@Table(name="brake_disc_hydraulics")
@NoArgsConstructor
@Getter
@Setter
public class BrakeDiscHydraulic {
    ...
    public BrakeLiquid getBrakeLiquid() {
        return brakeLiquid;
    }

    public void setBrakeLiquid(BrakeLiquid brakeLiquid) {
    ...
    public LengthHydroline getLengthHydroline() {
        return lengthHydroline;
    }

    public void setLengthHydroline(LengthHydroline lengthHydroline) {
