...
public class Stem {
    ...
    public Stem(HandlebarMaker handlebarMaker, String name,String angle,HandlebarDiameter handlebarDiameter, TubeDiameter tubeDiameter,String material,String length,
